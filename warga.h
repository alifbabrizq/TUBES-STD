...
/*
{I.S. listW tidak kosong. data terdefinisi NIK
 F.S. elemen dengan NIK tertentu akan dihapus}
*/
...
/*
{fungsi akan mengembalikan address dari Calon yang memiliki suara terbanyak,
 jika ada dua atau lebih calon yang memiliki suara terbanyak dan sama, maka kembalikan address calon dengan noCalon terbesar}
*/
...
{I.S. listW mungkin kosong.
 F.S. jumlahLaki telah menyimpan banyaknya pemilih ber-gender laki-laki dan
    jumlahPerempuan telah menyimpan banyaknya pemilih ber-gender perempuan yang memilih calon tertentu}
*/
...
{I.S. listW mungkin kosong.
 F.S. less20 telah menyimpan banyaknya pemilih berumur <= 20 dan
    over20 telah menyimpan banyaknya pemilih berumur > 20 yang memilih calon tertentu}
*/
